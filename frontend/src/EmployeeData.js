...
export function ListAllEmployees() {
    ...
    const FetchData = async () => {
      const data = await fetch('/management/search/all');
...
export function ListEmployeeActiveEmployee() {
  ...
  const FetchData = async () => {
    const data = await fetch('/management/search/status');
    const stats = await data.json();
    handleStats(stats)  
  }
...
export function RoleDistribution() {
  ...
  const FetchData = async () => {
    const data = await fetch('/management/search/roles');
    const stats = await data.json();
    handleStats(stats)  
  }
...
export function LocationDistribution() {
  ...
  const FetchData = async () => {
    const data = await fetch('/management/search/location');
    const stats = await data.json();
    handleStats(stats)  
  }
