...
export function RoleDistribution() {
  ...
  const FetchData = async () => {
    const data = await fetch(process.env.REACT_APP_GATEWAY_URL + "/management/search/roles");
    const stats = await data.json();
    handleStats(stats)  
  }
...
export function LocationDistribution() {
  ...
  const FetchData = async () => {
    const data = await fetch(process.env.REACT_APP_GATEWAY_URL + "/management/search/location");
    const stats = await data.json();
    handleStats(stats)  
  }
