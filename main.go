...
var templates = template.Must(template.New("Employee Management Template").Parse(htmltemplate))
...
func dbConn() (db *sql.DB) {
	db, err := sql.Open("mysql", "root:password@tcp(172.17.0.3:3306)/cc-dolcegusto")
    if err != nil {
